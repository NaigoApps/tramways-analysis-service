...
@Repository
public class AnalysisMongoRepositoryImpl implements AnalysisRepository {

    private final AnalysisMongoRepository analysisDelegate;

    public AnalysisMongoRepositoryImpl(
            AnalysisMongoRepository analysisDelegate
    ) {
