...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                .registerTypeSelector(AnalysisResult.class, new TypeSelector<AnalysisResult>() {
                    @Override
                    public Class<? extends AnalysisResult> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("StringAnalysisResult", StringAnalysisResult.class);
                        classByDiscriminatorValue.put("XYAnalysisResult", XYAnalysisResult.class);
                        classByDiscriminatorValue.put("AnalysisResult", AnalysisResult.class);
                ...
                .registerTypeSelector(XYAnalysisResult.class, new TypeSelector<XYAnalysisResult>() {
                    @Override
                    public Class<? extends XYAnalysisResult> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("XYAnalysisResult", XYAnalysisResult.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "resultType"));
