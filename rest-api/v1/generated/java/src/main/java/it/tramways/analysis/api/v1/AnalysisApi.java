...
public class AnalysisApi {
     ...
     */
    public okhttp3.Call deleteAnalysisCall(String analysisId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/analysis/{analysisId}"
    ...
    private okhttp3.Call deleteAnalysisValidateBeforeCall(String analysisId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteAnalysisCall(analysisId, _callback);
        return localVarCall;
     ...
     */
    public void deleteAnalysis(String analysisId) throws ApiException {
        deleteAnalysisWithHttpInfo(analysisId);
    }
     ...
     */
    public ApiResponse<Void> deleteAnalysisWithHttpInfo(String analysisId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteAnalysisAsync(String analysisId, final ApiCallback<Void> _callback) throws ApiException {
    ...
    private okhttp3.Call getAnalysisValidateBeforeCall(String analysisId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAnalysisCall(analysisId, _callback);
        return localVarCall;
     ...
     */
    public AnalysisDescription launchAnalysis(AnalysisRequest analysisRequest) throws ApiException {
        ApiResponse<AnalysisDescription> localVarResp = launchAnalysisWithHttpInfo(analysisRequest);
        return localVarResp.getData();
    }
     ...
     * 
     * @param analysisRequest  (optional)
     * @return ApiResponse&lt;AnalysisDescription&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AnalysisDescription> launchAnalysisWithHttpInfo(AnalysisRequest analysisRequest) throws ApiException {
        okhttp3.Call localVarCall = launchAnalysisValidateBeforeCall(analysisRequest, null);
        Type localVarReturnType = new TypeToken<AnalysisDescription>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call launchAnalysisAsync(AnalysisRequest analysisRequest, final ApiCallback<AnalysisDescription> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call updateAnalysisCall(String analysisId, AnalysisUpdateRequest analysisUpdateRequest, final ApiCallback _callback) throws ApiException {
        String basePath = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateAnalysisValidateBeforeCall(String analysisId, AnalysisUpdateRequest analysisUpdateRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateAnalysisCall(analysisId, analysisUpdateRequest, _callback);
        return localVarCall;
     ...
     */
    public Analysis updateAnalysis(String analysisId, AnalysisUpdateRequest analysisUpdateRequest) throws ApiException {
        ApiResponse<Analysis> localVarResp = updateAnalysisWithHttpInfo(analysisId, analysisUpdateRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Analysis> updateAnalysisWithHttpInfo(String analysisId, AnalysisUpdateRequest analysisUpdateRequest) throws ApiException {
    ...
    /**
     * Updates an analysis parameters (asynchronously)
     * 
     * @param analysisId  (required)
     * @param analysisUpdateRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call updateAnalysisAsync(String analysisId, AnalysisUpdateRequest analysisUpdateRequest, final ApiCallback<Analysis> _callback) throws ApiException {
