...
// @ts-ignore
import { AnalysisResponse } from '../../../../../it/tramways/analysis/api/v1/model';
// @ts-ignore
...
export const AnalysisApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        deleteAnalysis: async (projectId: string, mapId: string, analysisId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getAnalysis: async (projectId: string, mapId: string, analysisId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'projectId' is not null or undefined
...
export const AnalysisApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async deleteAnalysis(projectId: string, mapId: string, analysisId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getAnalysis(projectId: string, mapId: string, analysisId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Analysis>> {
         ...
         * @throws {RequiredError}
         */
        async launchAnalysis(analysisRequest?: AnalysisRequest, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<AnalysisResponse>> {
...
export class AnalysisApi extends BaseAPI {
     ...
     */
    public deleteAnalysis(projectId: string, mapId: string, analysisId: string, options?: AxiosRequestConfig) {
     ...
     * @memberof AnalysisApi
     */
    public getAnalysis(projectId: string, mapId: string, analysisId: string, options?: AxiosRequestConfig) {
